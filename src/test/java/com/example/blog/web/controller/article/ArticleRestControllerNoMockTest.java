...
class ArticleRestControllerNoMockTest {
    ...
    @Test
    @DisplayName("GET /articles/{id}: 指定されたIDの記事が存在するとき、200 OKで記事データを返す")
    @Sql(statements = """
            INSERT INTO articles (id, title, body, created_at, updated_at)
            VALUES (999, 'title_999', 'body_999', '2022-01-02 03:04:05', '2023-02-01 03:04:05');
            """)
    public void getArticle_return200() throws Exception {
        ...
        actual
                ...
                .andExpect(jsonPath("$.updatedAt").value("2023-02-01T03:04:05"));
    }
